...
const Header = () => {
  return (
    ...
    style={{backgroundImage: "url('/header_img.jpg')"}} id='Header'>
       ...
       <h2 className="text-5xl sm:text-6xl md:text-[82px] inline-block max-w-3xl font-semibold pt-20 animate-fadeInUp transform transition duration-500 ease-out hover:scale-105 hover:text-blue-500">
