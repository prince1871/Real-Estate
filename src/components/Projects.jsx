  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <div className='flex justify-end items-center mb-8'>
          ...
          className='p-3 rounded mr-2' aria-level='Previous Project'>
            <img src={assets.left_arrow} alt="Previous" />
          </button>
          <button onClick={nextProject} 
          className='p-3 rounded mr-2' aria-level='Next Project'>
        ...
        {/*  project slider container */}
          <div className='overflow-hidden'>
            <div className='flex gap-8 transition-transform duraton-500 ease-in-out'
